...
<div class="card mx-auto">
    <div class="card-body">
        <div class="card-title">
            <h2><button class ="btn btn-primary" onclick="history.back()"><i class="fa-solid fa-left-long"></i></button> Inserir Tarefa</h2>
        </div>
        <div class="card-text">
            <form method="POST" action="/task/{{ $project->id }}/store" class="row needs-validation" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control form-control-lg" name="descricao" id="descricao" cols="15" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
